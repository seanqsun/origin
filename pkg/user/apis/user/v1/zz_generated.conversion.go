...
func autoConvert_v1_IdentityMetadata_To_user_IdentityMetadata(in *v1.IdentityMetadata, out *user.IdentityMetadata, s conversion.Scope) error {
	...
	out.IdentityProviderName = in.IdentityProviderName
	out.IdentityProviderUserName = in.IdentityProviderUserName
	out.IdentityProviderGroups = *(*[]string)(unsafe.Pointer(&in.IdentityProviderGroups))
	out.IdentityProviderExtra = *(*map[string]user.OptionalNames)(unsafe.Pointer(&in.IdentityProviderExtra))
	return nil
}
...
func autoConvert_user_IdentityMetadata_To_v1_IdentityMetadata(in *user.IdentityMetadata, out *v1.IdentityMetadata, s conversion.Scope) error {
	...
	out.IdentityProviderUserName = in.IdentityProviderUserName
	out.IdentityProviderGroups = *(*[]string)(unsafe.Pointer(&in.IdentityProviderGroups))
	out.IdentityProviderExtra = *(*map[string]v1.OptionalNames)(unsafe.Pointer(&in.IdentityProviderExtra))
	return nil
}
